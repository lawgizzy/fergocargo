...
if(isset($_POST['sendmsg'])){
     ...
     $msg = trim($_POST['message']);
      ...
      if(!empty($fullname) && !empty($email) && !empty($subj) && !empty($msg) ){
        
          $query = "INSERT INTO feedback (message_id,fullname,email,subject,message,date_sent) VALUES (null,'$fullname','$email','$subj','$msg',now())";
                                    ...
                                    <div class="get-quote-form contact-info-form">
                                        ...
                                        <div class="contactform">
                                            ...
                                            <form id="contactform" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Complete Name" class="text-field input-style" id="name" name="fullname" required/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input type="email" placeholder="Email Address" id="email" name="email" class="text-field input-style" required/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input type="text" placeholder="Subject" name="subject" class="text-field input-style" required/>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <textarea placeholder="Message" class="text-field input-style" id="description" name="message" required></textarea>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <button id="quote-btn" name="sendmsg" title="" itemprop="url" type="submit" class="theme-btn"><i class="fa fa-paper-plane"></i>Contact Now</button>
                                                    </div>
                                                </div>
                                            </form> 
                                        </div>
