...
global $query_row,$msgid,$clientmail,$subj,$msg,$datesent;
          
          $query1 = "SELECT * FROM feedback";
          $query_data = mysqli_query($_SESSION['connect'],$query1);  
                                ...
                                <div class="col-md-8">
                                    <div class="get-quote-form contact-info-form">
                                        ...
                                        <div class="contactform">
                                            ...
                                            <h4><i class="fa fa-inbox"></i> Received Messages</h4><br>
                <div class="form-group"></div>
                          
                  <table class="table table-striped" id="intruders">
                            <tr style="background-color:#cfcdcd;">
                                <th>EMAIL</th><th>SUBJECT</th><th>MESSAGE</th><th>DATE SENT</th><th>   </th>
                            </tr>
                            <?php
                            while($query_row = mysqli_fetch_array($query_data)){
                  $msgid= $query_row['message_id'];
                  $clientmail = $query_row['email'];
                 $subj = $query_row['subject'];
                 $msg = $query_row['message'];
                 $datesent = $query_row['date_sent'];
                    ...
                    <tr>
                        ...
                        <td>$msg</td>
                        <td>$datesent</td>  
                        <td><a href='delmsg.php?clientToken=$msgid&&authen=delete' style='text-decoration:underline;'> Delete</a></td>
                    </tr> ";
                    }
               ?>
                  </table>
