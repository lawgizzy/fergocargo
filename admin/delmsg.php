...
if(!isset($_SESSION['id'])) echo '<script> window.location = "index.php?errorToken=thoiehjebfj9897hghtr566556&link=ioyh86ghfjfj78rtrjr89rt9";  </script>';
         if(isset($_POST['yes'])){
        $sql = "DELETE FROM feedback WHERE message_id={$_GET['clientToken']} LIMIT 1";
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="get-quote-form contact-info-form">
                                        <div class="heading2">
                                            <span> </span>
                                            <h4 style="font-weight:bolder;"><i class="fa fa-eraser"></i> You are about to delete the selected item. Do you wish to continue?</h4><br>
                                        </div>
                                 ...
                                 <form id="contactform" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                                                    ...
                                                    <div class="col-md-3">
                                                        <button id="quote-btn" name="yes" title="" itemprop="url" type="submit" class="theme-btn"><i class="fa fa-paper-plane"></i>Yes</button>
                                                    </div>
                                      <div class="col-md-3">
                                                        <button id="quote-btn" name="no" title="" itemprop="url" type="submit" class="theme-btn"><i class="fa fa-paper-plane"></i>No</button>
                                                    </div>
                                                </div>
                                            </form> 
